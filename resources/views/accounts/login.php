...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo cdn('/css/accounts-login.css'); ?>" />
    <!-- Java Script -->
...
<body>
    ...
    <script type="text/javascript" src="<?php echo cdn('/js/site.js'); ?>"></script>
    <script type="text/javascript">
        function getBackgroundImageUrl() {
            var imageNumber = Math.floor(Math.random() * 5);
            return 'url("<?php echo getCdnDomainUrl('*.jpg'); ?>/img/backgrounds/bg' + imageNumber + '.jpg")';
        }
    </script>
    <script type="text/javascript">
    ...
    <script type="text/javascript">
        function onSubmit() {
            ...
            doLoginAction(username, password, rememberMe, csrfToken);
        };
    </script>
    <script type="text/javascript">
        function doLoginAction(username, password, rememberMe, csrfToken) {
            var postData = {
                'username': username,
                'password': password,
